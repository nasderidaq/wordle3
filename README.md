...
Runnable playground [here](https://htmlpreview.github.io/?https://github.com/nasderidaq/wordle3/blob/master/src/wordle.html) (use the console and the `window.wordle` exports).
